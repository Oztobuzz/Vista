...
class FilteringPerplexity:
    def __init__(self, dataset, sentencepiece_model_path, kenlm_model_path, num_proc):
    ...
    def compute(self, conversation_feature_name="conversation", content_feature_name="content"):
